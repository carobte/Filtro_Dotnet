    ...
    public class RoomSeeders
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Room>().HasData(
                ...
                new Room { Id = 2, RoomNumber = "102", PricePerNight = 50, Availability = false, MaxOcuppancy = 1, RoomTypeId = 1 },
                ...
                new Room { Id = 5, RoomNumber = "105", PricePerNight = 50, Availability = false, MaxOcuppancy = 1, RoomTypeId = 1 },

                new Room { Id = 6, RoomNumber = "106", PricePerNight = 80, Availability = true, MaxOcuppancy = 2, RoomTypeId = 2 },
                new Room { Id = 7, RoomNumber = "107", PricePerNight = 80, Availability = false, MaxOcuppancy = 2, RoomTypeId = 2 },
                new Room { Id = 8, RoomNumber = "108", PricePerNight = 80, Availability = true, MaxOcuppancy = 2, RoomTypeId = 2 },
                new Room { Id = 9, RoomNumber = "109", PricePerNight = 80, Availability = false, MaxOcuppancy = 2, RoomTypeId = 2 },
                ...
                new Room { Id = 12, RoomNumber = "202", PricePerNight = 150, Availability = false, MaxOcuppancy = 2, RoomTypeId = 3 },
                ...
                new Room { Id = 15, RoomNumber = "205", PricePerNight = 150, Availability = false, MaxOcuppancy = 2, RoomTypeId = 3 },
                ...
                new Room { Id = 18, RoomNumber = "208", PricePerNight = 200, Availability = false, MaxOcuppancy = 4, RoomTypeId = 4 },
                ...
                // 3rd Floor 
                new Room { Id = 21, RoomNumber = "301", PricePerNight = 50, Availability = false, MaxOcuppancy = 1, RoomTypeId = 1 },
                ...
                new Room { Id = 24, RoomNumber = "304", PricePerNight = 50, Availability = false, MaxOcuppancy = 1, RoomTypeId = 1 },
                new Room { Id = 25, RoomNumber = "305", PricePerNight = 50, Availability = true, MaxOcuppancy = 1, RoomTypeId = 1 },

                new Room { Id = 26, RoomNumber = "306", PricePerNight = 80, Availability = false, MaxOcuppancy = 2, RoomTypeId = 2 },
                new Room { Id = 27, RoomNumber = "307", PricePerNight = 80, Availability = true, MaxOcuppancy = 2, RoomTypeId = 2 },
                new Room { Id = 28, RoomNumber = "308", PricePerNight = 80, Availability = false, MaxOcuppancy = 2, RoomTypeId = 2 },
                new Room { Id = 29, RoomNumber = "309", PricePerNight = 80, Availability = true, MaxOcuppancy = 2, RoomTypeId = 2 },
                new Room { Id = 30, RoomNumber = "310", PricePerNight = 80, Availability = false, MaxOcuppancy = 2, RoomTypeId = 2 },
                ...
                new Room { Id = 33, RoomNumber = "403", PricePerNight = 150, Availability = false, MaxOcuppancy = 2, RoomTypeId = 3 },
                ...
                new Room { Id = 37, RoomNumber = "407", PricePerNight = 200, Availability = false, MaxOcuppancy = 4, RoomTypeId = 4  },
                ...
                // 5th Floor 
                new Room { Id = 41, RoomNumber = "501", PricePerNight = 50, Availability = false, MaxOcuppancy = 1, RoomTypeId = 1  },
                ...
                new Room { Id = 45, RoomNumber = "505", PricePerNight = 50, Availability = false, MaxOcuppancy = 1, RoomTypeId = 1  },

                new Room { Id = 46, RoomNumber = "506", PricePerNight = 200, Availability = true, MaxOcuppancy = 4, RoomTypeId = 4  },
                new Room { Id = 47, RoomNumber = "507", PricePerNight = 200, Availability = false, MaxOcuppancy = 4, RoomTypeId = 4  },
                new Room { Id = 48, RoomNumber = "508", PricePerNight = 200, Availability = false, MaxOcuppancy = 4, RoomTypeId = 4  },
                new Room { Id = 49, RoomNumber = "509", PricePerNight = 200, Availability = true, MaxOcuppancy = 4, RoomTypeId = 4  },
                new Room { Id = 50, RoomNumber = "510", PricePerNight = 200, Availability = false, MaxOcuppancy = 4, RoomTypeId = 4  }
            );
        }
    }
}